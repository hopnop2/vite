  ...
  return (
    <div className={`navbar sticky top-0 z-50 transition-all duration-300 ${
      ...
      <div className="flex-1">
        <a className="  gap-2 btn btn-ghost normal-case text-3xl font-bold">
      ...
      <div className="hidden md:flex">
        <ul className="menu menu-horizontal space-x-2 px-1">
          <li>
            <a href="/home" className="hover:bg-green-700 rounded-full font-bold transition duration-200 flex gap-2 items-center">
          ...
          <li>
            <a href="/fruits" className="hover:bg-green-700 rounded-full font-bold transition duration-200 flex gap-2 items-center  ">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li>
            <details>
              <summary className="hover:bg-green-700 rounded-full font-bold transition duration-200 flex gap-2 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li>
            <a href="/contact" className="hover:bg-green-700 rounded-full font-bold transition duration-200 flex gap-2 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
